...
| :--- | :--- | :--- |
| **[Bayesian Heart Failure Predictor](https://github.com/KaiserAI/Bayesian-Heart-Failure-Clinical-Risk-Prediction-with-Uncertainty-QuantificationBayesian-Heart-Failure-Clinical-Risk-Prediction-with-Uncertainty-Quantification)** | Python, MCMC (Custom) | **Decision Thresholding:** Tuned for **zero false positives** to reflect clinical resource constraints. Implemented Metropolis-Hastings from scratch to model uncertainty explicitly. |
